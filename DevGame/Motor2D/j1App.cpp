...
{
	BROFILER_CATEGORY("PrepareUpdate", Profiler::Color::Orchid)
	frame_count++;
...
{
	BROFILER_CATEGORY("FinishUpdate", Profiler::Color::Orchid)
...
bool j1App::DoUpdate()
{
	BROFILER_CATEGORY("DoUpdate", Profiler::Color::Orchid)
	bool ret = true;
	p2List_item<j1Module*>* item;
	item = modules.start;
	j1Module* pModule = NULL;
